...
**影像类 App 用户行为分析与留存转化项目｜个人项目｜2026.07**  
技术栈：SQL、Excel、Python、Pandas｜GitHub：photo-app-user-retention-sql-analysis

1. 构建用户、行为、订单三类模拟数据，模拟注册、上传照片、使用滤镜、导出、分享、订阅点击和付费购买等核心行为路径；
2. 使用 SQL 计算 DAU、新增用户数、次日留存率、7日留存率、功能转化率、付费转化率、ARPPU 和复购率等核心指标；
3. 使用 Excel 制作留存趋势、转化漏斗、渠道质量对比和付费分析图表，并输出针对渠道投放、功能优化和会员转化的业务分析结论。
